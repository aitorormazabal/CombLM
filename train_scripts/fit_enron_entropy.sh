...
dataset_path=$COMBLM_DIR/prepared_datasets/enron_10k/opt/valid_test_split/
model_1_path=$COMBLM_DIR/models/opt-1.3b_enron/

save_base_path=$COMBLM_DIR/models/fit_combinations_enron_entropy/
...
save_path=$save_base_path/${model_type}_${max_train}_${dataset_name}

echo RUNNING $model_type $max_train $dataset_name no_mixin 
python3 $train_path \
